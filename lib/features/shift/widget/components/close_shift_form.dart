...
class CloseShiftError extends StatelessWidget {
  final Function() onClose;
  final Function() onRetry;
  final String? error;
  const CloseShiftError(
      {required this.onRetry, this.error, super.key, required this.onClose});
...
class CloseShiftSuccess extends ConsumerWidget {
  final Function() onClose;
  final bool isAutoShift;
  const CloseShiftSuccess({
