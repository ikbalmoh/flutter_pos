...
import 'package:selleri/features/adjustment/widget/components/adjustment_item_form.dart';
import 'package:selleri/features/adjustment/widget/components/submit_adjustment_sheet.dart';
import 'package:selleri/shared/utils/app_alert.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:selleri/shared/utils/formater.dart';

class AdjustmentCart extends ConsumerWidget {
  const AdjustmentCart({super.key, this.asWidget, this.isLoading});
                                ...
                                Flexible(
                                  ...
                                  child: OutlinedButton(
                                    style: OutlinedButton.styleFrom(
                                      padding: const EdgeInsets.symmetric(
                                          horizontal: 15),
                                      foregroundColor: isLoading == true
                                          ? Colors.grey
                                          : Colors.blue,
                                      side: BorderSide(
