...
Map<String, dynamic> _$$ShiftSummaryImplToJson(_$ShiftSummaryImpl instance) =>
    <String, dynamic>{
      ...
      'debit_sales': instance.debitSales?.map((e) => e.toJson()).toList(),
      'credit_sales': instance.creditSales?.map((e) => e.toJson()).toList(),
      'custom_sales': instance.customSales?.map((e) => e.toJson()).toList(),
